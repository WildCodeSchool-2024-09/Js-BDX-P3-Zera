    ...
    <main className={styles.teamSection}>
      ...
      <article className={styles.teamMember}>
        ...
        <p className={styles.textTeam}>
          ...
          s’inspirant des livres et des jeux vidéos de son enfance. Zera est né
          de son envie de vulgariser les termes de l’informatique et de
      ...
      <article className={styles.teamMember}>
        ...
        <p className={styles.textTeam}>
          ...
          artistes et réalise des commandes pour de nombreux artistes notamment
          de la scène reggae Dub européenne. L’artiste a réalisé le Logo de
          l’application !
        </p>
      </article>
      ...
      <article className={styles.teamMember}>
        ...
        <p className={styles.textTeam}>
          ...
          développeurs web, composée de Thomas, Julien, Florian et Roxanne. Ils
          ont donné vie à cet univers interactif sous la forme d’un jeu mobile
          captivant.
        </p>
      </article>
    </main>
